...
| 页面 | 预览 |
|------|------|
| **智能问候封面** — 不同时段自适应问候 | ![](screenshots/1.png) |
| **主菜单** — 功能卡片导航 | ![](screenshots/2.png) |
| **存入消费** — 选择类型、填写商品与价格 | ![](screenshots/3.png) |
| **消费查询** — 月度统计、折线图、日明细、特殊消费 | ![](screenshots/4.png) |
| **消费管控** — 预算监控、赤字概率、超额预警 | ![](screenshots/5.png) |
